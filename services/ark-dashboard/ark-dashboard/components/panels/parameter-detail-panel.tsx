...
import { Plus, X, ChevronDown, ChevronRight, AlertCircle, Settings } from "lucide-react"
                ...
                <Collapsible open={isExpanded} onOpenChange={() => toggleParameterExpanded(index)}>
                  <CardHeader className="pb-2">
                    ...
                    {!isExpanded && param.value && (
                      ...
                      >
                        {param.value.length > 120 ? `${param.value.substring(0, 120)}...` : param.value}
                      </div>
                    )}
                  </CardHeader>
                    ...
                    <CardContent className="pt-0 space-y-3">
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="text-xs text-muted-foreground">
                          {param.value.length} characters
                        </div>
                      </div>

                      {param.name === "evaluator_role" && param.value && (
                        <div className="bg-muted/50 p-3 rounded text-xs">
                          <div className="font-medium mb-2">Evaluator Role Preview:</div>
