...
```bash
# Install the ark-evaluator service
helm install ark-evaluator ./services/ark-evaluator/chart

# Verify deployment
kubectl get pods -l app.kubernetes.io/name=ark-evaluator
kubectl get evaluator ark-evaluator
```
...
```bash
# Check service logs
kubectl logs -l app.kubernetes.io/name=ark-evaluator

# View evaluator status
kubectl get evaluator ark-evaluator -o yaml
